...
INPUT_FILE_PATH = r"D:\Giao trinh\csdl phan tan\bai_tap_lon_CSDL_phan_tan\test_data.dat"
ACTUAL_ROWS_IN_INPUT_FILE = 20  # Number of lines in the input file

import psycopg2
import traceback
import testHelper
import function as MyAssignment

if __name__ == '__main__':
    try:
        testHelper.createdb(DATABASE_NAME)

        with testHelper.getopenconnection("postgres","root","db_assign1") as conn:
